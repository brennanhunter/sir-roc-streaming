...
export default function PitchPage() {
  ...
  return (
    <div className="min-h-screen bg-dark text-light">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-dark via-secondary to-dark py-20">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(27,152,224,0.1),transparent_50%)]"></div>
        ...
        <div className="relative max-w-6xl mx-auto px-6 text-center">
          <div className="flex items-center justify-center mb-8">
            ...
            <h1 className="text-5xl md:text-7xl font-bold">
              ...
              <span className="text-light ml-4">STREAM</span>
            </h1>
          </div>
          
          <h2 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">
            Turn Every Fight Into
            <span className="text-primary block">$3,000+ Revenue</span>
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            <div className="bg-dark/50 p-6 rounded-xl border border-primary/30">
              <div className="text-3xl font-bold text-primary mb-2">200</div>
              <div className="text-light/70">Viewers Needed</div>
            </div>
            <div className="bg-dark/50 p-6 rounded-xl border border-primary/30">
              <div className="text-3xl font-bold text-primary mb-2">$15</div>
              <div className="text-light/70">Per Pay-Per-View</div>
            </div>
            <div className="bg-dark/50 p-6 rounded-xl border border-primary/30">
              <div className="text-3xl font-bold text-primary mb-2">$2,835</div>
              <div className="text-light/70">Profit Per Event</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Your Fights Deserve <span className="text-primary">Better</span>
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-3xl font-bold mb-6 text-primary">Current Problems:</h3>
            ...
            <div className="bg-dark p-8 rounded-xl border border-secondary">
              <h4 className="text-2xl font-bold mb-4 text-primary">The Reality</h4>
      ...
      <div className="py-20 bg-dark">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              <span className="text-primary">Sir Roc Stream</span> Changes Everything
            </h2>
            <p className="text-xl text-light/60 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-secondary p-8 rounded-xl border border-primary/30 hover:border-primary transition-all">
              <div className="text-4xl mb-4">🎬</div>
              <h3 className="text-2xl font-bold mb-4 text-primary">Professional Streaming</h3>
            ...
            <div className="bg-secondary p-8 rounded-xl border border-primary/30 hover:border-primary transition-all">
              <div className="text-4xl mb-4">💰</div>
              <h3 className="text-2xl font-bold mb-4 text-primary">Instant Revenue</h3>
              <p className="text-light/80">
            ...
            <div className="bg-secondary p-8 rounded-xl border border-primary/30 hover:border-primary transition-all">
              <div className="text-4xl mb-4">🏆</div>
              <h3 className="text-2xl font-bold mb-4 text-primary">Sir Roc Branded</h3>
              <p className="text-light/80">
          ...
          {/* Demo Preview */}
          <div className="bg-secondary rounded-2xl p-8 border border-primary/50">
            <h3 className="text-3xl font-bold mb-6 text-center text-primary">See It In Action</h3>
            <div className="aspect-video bg-dark rounded-xl border-2 border-secondary overflow-hidden">
              <video 
      ...
      <div className="py-20 bg-gray-900">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            {/* Revenue Calculation */}
            <div className="bg-secondary p-8 rounded-xl border border-primary/50">
              <h3 className="text-3xl font-bold mb-6 text-primary">Revenue Per Event</h3>
              <div className="space-y-4 text-lg">
                ...
                <div className="border-t border-gray-700 pt-4 flex justify-between text-xl font-bold">
                  ...
                  <span className="text-primary">$2,835</span>
                </div>
              </div>
            </div>
            ...
            {/* Annual Projection */}
            <div className="bg-secondary p-8 rounded-xl border border-primary/50">
              <h3 className="text-3xl font-bold mb-6 text-primary">Annual Revenue</h3>
              <div className="space-y-4 text-lg">
                <div className="flex justify-between">
                ...
                <div className="border-t border-gray-700 pt-4 flex justify-between text-xl font-bold">
                  ...
                  <span className="text-primary">$18,810</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="py-20 bg-black">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Choose Your <span className="text-primary">Partnership</span>
            </h2>
            <p className="text-xl text-gray-400">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Starter Tier */}
            <div className="bg-secondary p-8 rounded-xl border border-gray-600 hover:border-primary/50 transition-all">
            ...
            {/* Professional Tier */}
            <div className="bg-secondary p-8 rounded-xl border-2 border-primary relative transform scale-105">
              ...
              <div className="text-center">
                <a 
                  ...
                  className="w-full bg-primary hover:bg-primary/90 text-white py-3 px-6 rounded-lg font-bold transition-colors inline-block"
                >
                  Contact Us
                </a>
              </div>
      ...
      <div className="py-20 bg-gray-900">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              <span className="text-primary">Launch</span> Timeline
            </h2>
            <p className="text-xl text-gray-400">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-2 text-primary">Week 1</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-2 text-primary">Week 2</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-2 text-primary">Week 3</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-2 text-primary">Week 4</h3>
      ...
      <div className="py-20 bg-black">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-6xl font-bold mb-6">
            Ready to <span className="text-primary">Monetize</span> Your Fights?
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-12">
            <a 
              ...
              className="bg-primary hover:bg-primary/90 text-white py-4 px-8 rounded-lg font-bold text-lg transition-colors inline-block"
            >
              Schedule a Call
            </a>
             <Link 
              href="/" 
              className="border-2 border-primary text-primary hover:bg-primary hover:text-white py-4 px-8 rounded-lg font-bold text-lg transition-colors inline-block"
            >
              See Live Demo
            </Link>
          ...
          <div className="bg-gray-900/50 rounded-xl p-8 border border-gray-700 mb-8">
            ...
            <p className="text-gray-300 mb-6">
              This platform is developed by <strong className="text-primary">Xtremery</strong>, 
          ...
          <div className="bg-secondary/50 rounded-xl p-8 border border-primary/30">
      ...
      {showCostModal && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-secondary rounded-2xl border border-primary w-full max-w-2xl max-h-[90vh] flex flex-col">
            {/* Fixed Header */}
            <div className="flex justify-between items-center p-6 border-b border-gray-700">
              <h3 className="text-2xl md:text-3xl font-bold text-primary">Monthly Platform Costs</h3>
              <button
              ...
              <div className="space-y-6">
                ...
                <div className="border-t border-gray-700 pt-6">
                  <div className="flex justify-between text-xl font-bold">
                    ...
                    <span className="text-primary">$165/month</span>
                  </div>
            ...
            <div className="p-6 border-t border-gray-700 text-center">
              <button
                onClick={() => setShowCostModal(false)}
                className="bg-primary hover:bg-primary/90 text-white py-3 px-8 rounded-lg font-bold transition-colors"
              >
                Got It
              </button>
            </div>
